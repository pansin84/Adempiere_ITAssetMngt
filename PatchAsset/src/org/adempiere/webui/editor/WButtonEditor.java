...
public class WButtonEditor extends WEditor
{
    ...
    public void setValue(Object value)
    {
        ...
        if (super.getColumnName().equals("AttachQuotation")){
        		getComponent().setLabel("Upload/Replace Quotation");
        }else if (super.getColumnName().equals("AttachCER")){
        		getComponent().setLabel("Upload/Replace CER"); 
        }else if (super.getColumnName().equals("AttachPO")){
        		getComponent().setLabel("Upload/Replace PO"); 
        }else if (super.getColumnName().equals("AttachGP")){
        		getComponent().setLabel("Upload/Replace Gate-Pass"); 
        }else if (super.getColumnName().equals("AttachChallan")){
        		getComponent().setLabel("Upload/Replace Challan"); 
        }else
