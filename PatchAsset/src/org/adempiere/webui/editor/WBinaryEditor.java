...
public class WBinaryEditor extends WEditor
{
    ...
    public void setValue(Object value)
    {
		...
		m_data = value;
		if (m_data == null){
			if (columnName.equals("AttachQuotation")){
	            getComponent().setLabel("Upload/Replace Quotation"); 
	        }else if (columnName.equals("AttachCER")){
	            getComponent().setLabel("Upload/Replace CER"); 
	        }else if (columnName.equals("AttachPO")){
	            getComponent().setLabel("Upload/Replace PO"); 
	        }else if (columnName.equals("AttachGP")){
	            getComponent().setLabel("Upload/Replace Gate-Pass"); 
	        }else 
	        	getComponent().setLabel("-");
		}else
		{
			...
			if (columnName.equals("AttachQuotation")){
	            getComponent().setLabel(("Quotation Uploaded").concat("-").concat(text)); 
	        }else if (columnName.equals("AttachCER")){
	            getComponent().setLabel(("CER Uploaded").concat("-").concat(text)); 
	        }else if (columnName.equals("AttachPO")){
	            getComponent().setLabel(("PO Uploaded").concat("-").concat(text));
	        }else if (columnName.equals("AttachGP")){
	            getComponent().setLabel(("Gate-Pass Uploaded").concat("-").concat(text));
	        }else 
