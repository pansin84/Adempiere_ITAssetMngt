 ...
 */
public class InfoProductPanelOld extends InfoPanel implements EventListener, ValueChangeListener
{
	/**
	 * 
	 */
	 ...
	 */
	public InfoProductPanelOld(int windowNo,
	 ...
	 */
	public InfoProductPanelOld(int windowNo, boolean modal,
		int M_Warehouse_ID, int M_PriceList_ID, int record_id, String value,
