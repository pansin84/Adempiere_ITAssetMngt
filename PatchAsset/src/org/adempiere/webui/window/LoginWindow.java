...
public class LoginWindow extends FWindow implements EventListener
{
    ...
    public void loginOk(String userName, String password,boolean LoginuserName,boolean LoginEmail,boolean LoginEmpCode)
    {
        pnlRole = new RolePanel(ctx, this, userName, password,LoginuserName,LoginEmail,LoginEmpCode);
        this.getChildren().clear();
        this.appendChild(pnlRole);
    }
