...
//	private BorderLayout conTabLayout = new BorderLayout();
	...
	private CLabel LoginLabel = new CLabel();
...
//	private BorderLayout defaultLayout = new BorderLayout();
	...
	private ConfirmPanel confirmPanel = new ConfirmPanel(true, false, false, false, false, false, false);
	 final JRadioButton userName = new JRadioButton("User Name", true);
     final JRadioButton Email = new JRadioButton("EMail");
     final JRadioButton empCode = new JRadioButton("Employee Code");
	...
	private void jbInit() throws Exception
	{
		...
		loginTabPane.addChangeListener(this);
		 ...
		 ButtonGroup group = new ButtonGroup();
	      ...
	      empCode.addActionListener(this);
		...
		connectionPanel.add(LoginLabel,        new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0
				,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 12, 5, 5), 0, 0));
		connectionPanel.add(empCode,         new GridBagConstraints(3, 3, 3, 1, 1.0, 0.0
				,GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(5, 12, 5, 12), 0, 0));
		connectionPanel.add(Email,         new GridBagConstraints(2, 3, 3, 1, 1.0, 0.0
				,GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(5, 5, 5, 12), 0, 0));
		connectionPanel.add(userName,         new GridBagConstraints(1, 3, 3, 1, 1.0, 0.0
				,GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(5, 0, 5, 12), 0, 0));
		...
		userLabel.setLabelFor(userTextField);
		connectionPanel.add(userLabel,        new GridBagConstraints(0, 4, 1, 1, 0.0, 0.0
			,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 12, 5, 5), 0, 0));
		userTextField.setText("System");			//	default
		connectionPanel.add(userTextField,         new GridBagConstraints(1, 4, 3, 1, 1.0, 0.0
			,GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(5, 0, 5, 12), 0, 0));
		passwordLabel.setHorizontalAlignment(SwingConstants.RIGHT);
		passwordLabel.setText("Password");
		passwordLabel.setLabelFor(passwordField);
		connectionPanel.add(passwordLabel,         new GridBagConstraints(0, 5, 1, 1, 0.0, 0.0
			,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 12, 5, 5), 0, 0));
		passwordField.setText("System");			//	default
		connectionPanel.add(passwordField,         new GridBagConstraints(1, 5, 3, 1, 1.0, 0.0
		...
		// @Trifon - begin
		connectionPanel.add(languageLabel,        new GridBagConstraints(0, 6, 1, 1, 0.0, 0.0
			,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 12, 5, 5), 0, 0));
		connectionPanel.add(languageCombo,          new GridBagConstraints(1, 6, 3, 1, 1.0, 0.0
			,GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(5, 0, 5, 12), 0, 0));
		// @Trifon - end
		copy0Label.setHorizontalAlignment(SwingConstants.RIGHT);
		connectionPanel.add(copy0Label,       new GridBagConstraints(0, 7, 1, 1, 0.0, 0.0
			,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 0, 0));

		copy1Label.setText(Adempiere.COPYRIGHT);
		connectionPanel.add(copy1Label,         new GridBagConstraints(1, 7, 2, 1, 0.0, 0.0
...
//			roles = m_login.getRoles(m_user, m_pwd);
			...
			System.out.println(empCode.isSelected());
			roles = m_login.getRoles(m_user, m_pwd,userName.isSelected(),Email.isSelected(),empCode.isSelected());
	...
	private void clientComboChanged()
	{
        ...
        KeyNamePair rolesKNPairs[] = m_login.getRoles(userTextField.getText() , new String (passwordField.getPassword()),userName.isSelected(),Email.isSelected(),empCode.isSelected());
