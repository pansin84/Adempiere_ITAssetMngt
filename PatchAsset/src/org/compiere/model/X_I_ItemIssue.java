...
/** Generated Model for I_ItemIssue
 *  @author Adempiere (generated) 
 *  @version Release 3.8.0 - $Id$ */
public class X_I_ItemIssue extends PO implements I_I_ItemIssue, I_Persistent 
{
    ...
    public X_I_ItemIssue (Properties ctx, int I_ItemIssue_ID, String trxName)
    {
      super (ctx, I_ItemIssue_ID, trxName);
      /** if (I_ItemIssue_ID == 0)
        {
...
// N
    ...
    /** Load Constructor */
    public X_I_ItemIssue (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_I_ItemIssue[")
	...
	{
		set_Value (COLUMNNAME_EmpLocation, EmpLocation);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_EmpLocation);
	}
	...
	/** Set Import Item Issue ID.
		@param I_ItemIssue_ID Import Item Issue ID	  */
	public void setI_ItemIssue_ID (int I_ItemIssue_ID)
	{
		if (I_ItemIssue_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_I_ItemIssue_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_I_ItemIssue_ID, Integer.valueOf(I_ItemIssue_ID));
	}

	/** Get Import Item Issue ID.
		@return Import Item Issue ID	  */
	public int getI_ItemIssue_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_I_ItemIssue_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
