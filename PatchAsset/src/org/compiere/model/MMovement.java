					...
					for (int j = 0; j < mas.length; j++)
					{
						...
						if(line.getDeviceSerialNo()!=null){
							if (!MStorage.add(getCtx(),locator.getM_Warehouse_ID(),
									...
									line.isLaptopDektop(),line.isPrinter(),line.isPrinterAccessory(),line.isLDAccessory(),
									line.isNetComp(),line.isInternet(),line.getDM_StorageDetails_ID(),line.getDM_AssetModelDetails_ID(),
									line.getDeviceSerialNo(),line.getAssetManufacturer_ID(),line.getM_Product_Category_ID(),
