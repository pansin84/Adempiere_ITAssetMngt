...
/** Generated Model for DM_DMSEmployeeType
 *  @author Adempiere (generated) 
 *  @version Release 3.8.0 - $Id$ */
public class X_DM_DMSEmployeeType extends PO implements I_DM_DMSEmployeeType, I_Persistent 
{
    ...
    public X_DM_DMSEmployeeType (Properties ctx, int DM_DMSEmployeeType_ID, String trxName)
    {
      super (ctx, DM_DMSEmployeeType_ID, trxName);
      /** if (DM_DMSEmployeeType_ID == 0)
        {
			setDM_DMSEmployeeType_ID (0);
			setName (null);
			setWageLevel (null);
        } */
    }
    ...
    /** Load Constructor */
    public X_DM_DMSEmployeeType (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_DM_DMSEmployeeType[")
	...
	public void setDM_DMSEmployeeType_ID (int DM_DMSEmployeeType_ID)
	{
		if (DM_DMSEmployeeType_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_DM_DMSEmployeeType_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_DM_DMSEmployeeType_ID, Integer.valueOf(DM_DMSEmployeeType_ID));
	}
