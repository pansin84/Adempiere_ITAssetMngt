...
public class GridTab implements DataStatusListener, Evaluatee, Serializable
{
	...
	private HashMap<Integer,Integer>	m_invAttachments = null;
	/** Chats				*/
	...
	/**************************************************************************
	 *	Load Inventory Attachments for this table
	 */
//	public void loadInventoryAttachments(String Type)
//	{
//		if(!m_invAttachments.isEmpty()){
//			m_invAttachments.clear();
//			m_invAttachments = null;
//		}
//		
//		log.fine("#" + m_vo.TabNo);
//		if (!canHaveInvAttachment())
//			return;
//
//		String SQL = "SELECT DM_InventoryAttachment_ID, Record_ID FROM DM_InventoryAttachment "
//			+ "WHERE AD_Table_ID=? AND Type=?";
//		try
//		{
//			if (m_invAttachments == null)
//				m_invAttachments = new HashMap<Integer,Integer>();
//			else
//				m_invAttachments.clear();
//			PreparedStatement pstmt = DB.prepareStatement(SQL, null);
//			pstmt.setInt(1, m_vo.AD_Table_ID);
...
//				Integer key = new Integer(rs.getInt(2));
//				Integer value = new Integer(rs.getInt(1));
//				m_invAttachments.put(key, value);
//			}
//			rs.close();
//			pstmt.close();
//		}
//		catch (SQLException e)
//		{
//			log.log(Level.SEVERE, "loadInventoryAttachments", e);
//		}
//		log.config("#" + m_invAttachments.size());
//	}	//	loadInventoryAttachment
	...
	public boolean canHaveInvAttachment()
	{
		if (getKeyColumnName().endsWith("_ID"))
			return true;
		return false;
...
//	public boolean hasInventoryAttachment(String Type)
//	{
//		if(!m_invAttachments.isEmpty()){
//			m_invAttachments.clear();
//			m_invAttachments = null;
...
//		
//		if (m_invAttachments == null)
//			loadInventoryAttachments(Type);
//		if (m_invAttachments == null || m_invAttachments.isEmpty())
//			return false;
//		//
//		Integer key = new Integer(m_mTable.getKeyID (m_currentRow));
//		return m_invAttachments.containsKey(key);
//	}	//	hasAttachment
//
//	/**
...
//	 */
//	public int getDM_InventoryAttachmentID(String Type)
//	{
//		if(!m_invAttachments.isEmpty()){
//			m_invAttachments.clear();
//			m_invAttachments = null;
...
//		//
//		Integer key = new Integer(m_mTable.getKeyID (m_currentRow));
//		Integer value = (Integer)m_invAttachments.get(key);
//		if (value == null)
//			return 0;
//		else
