...
/** Generated Model for DM_EmpEducation
 *  @author Adempiere (generated) 
 *  @version Release 3.8.0 - $Id$ */
public class X_DM_EmpEducation extends PO implements I_DM_EmpEducation, I_Persistent 
{
    ...
    public X_DM_EmpEducation (Properties ctx, int DM_EmpEducation_ID, String trxName)
    {
      super (ctx, DM_EmpEducation_ID, trxName);
      /** if (DM_EmpEducation_ID == 0)
        {
			setDM_DMSEmployee_ID (0);
			setDM_EmpEducation_ID (0);
			setHR_Degree_ID (0);
			setYearOfPassing (null);
// @SQL=SELECT EXTRACT(YEAR FROM TIMESTAMP 'now()')
        } */
    }

    /** Load Constructor */
    public X_DM_EmpEducation (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_DM_EmpEducation[")
	...
	/** Set Employee Education ID.
		@param DM_EmpEducation_ID Employee Education ID	  */
	public void setDM_EmpEducation_ID (int DM_EmpEducation_ID)
	{
		if (DM_EmpEducation_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_DM_EmpEducation_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_DM_EmpEducation_ID, Integer.valueOf(DM_EmpEducation_ID));
	}

	/** Get Employee Education ID.
		@return Employee Education ID	  */
	public int getDM_EmpEducation_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_DM_EmpEducation_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
