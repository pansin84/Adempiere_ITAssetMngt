...
// 5
	...
	/** Set Attach CER.
		@param AttachCER Attach CER	  */
	public void setAttachCER (byte[] AttachCER)
	{
		set_Value (COLUMNNAME_AttachCER, AttachCER);
	}

	/** Get Attach CER.
		@return Attach CER	  */
	public byte[] getAttachCER () 
	{
		return (byte[])get_Value(COLUMNNAME_AttachCER);
	}

	/** Set Attach Delivery Challan.
		@param AttachChallan Attach Delivery Challan	  */
	public void setAttachChallan (byte[] AttachChallan)
	{
		set_Value (COLUMNNAME_AttachChallan, AttachChallan);
	}

	/** Get Attach Delivery Challan.
		@return Attach Delivery Challan	  */
	public byte[] getAttachChallan () 
	{
		return (byte[])get_Value(COLUMNNAME_AttachChallan);
	}

	/** Set Attach Gate Pass.
		@param AttachGP Attach Gate Pass	  */
	public void setAttachGP (byte[] AttachGP)
	{
		set_Value (COLUMNNAME_AttachGP, AttachGP);
	}

	/** Get Attach Gate Pass.
		@return Attach Gate Pass	  */
	public byte[] getAttachGP () 
	{
		return (byte[])get_Value(COLUMNNAME_AttachGP);
	}

	/** Set Attach PO.
		@param AttachPO Attach PO	  */
	public void setAttachPO (byte[] AttachPO)
	{
		set_Value (COLUMNNAME_AttachPO, AttachPO);
	}

	/** Get Attach PO.
		@return Attach PO	  */
	public byte[] getAttachPO () 
	{
		return (byte[])get_Value(COLUMNNAME_AttachPO);
	}

	/** Set Attach Quotation.
		@param AttachQuotation Attach Quotation	  */
	public void setAttachQuotation (byte[] AttachQuotation)
	{
		set_Value (COLUMNNAME_AttachQuotation, AttachQuotation);
	}

	/** Get Attach Quotation.
		@return Attach Quotation	  */
	public byte[] getAttachQuotation () 
	{
		return (byte[])get_Value(COLUMNNAME_AttachQuotation);
	}
	...
	/** Set Carry Through.
		@param CarryThrough Carry Through	  */
	public void setCarryThrough (String CarryThrough)
	{
		set_Value (COLUMNNAME_CarryThrough, CarryThrough);
	}

	/** Get Carry Through.
		@return Carry Through	  */
	public String getCarryThrough () 
	{
		return (String)get_Value(COLUMNNAME_CarryThrough);
	}

	/** Set CER Date.
		@param CERDate CER Date	  */
	public void setCERDate (Timestamp CERDate)
	{
		set_Value (COLUMNNAME_CERDate, CERDate);
	}

	/** Get CER Date.
		@return CER Date	  */
	public Timestamp getCERDate () 
	{
		return (Timestamp)get_Value(COLUMNNAME_CERDate);
	}
	...
	{
		set_Value (COLUMNNAME_CERNO, CERNO);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_CERNO);
	}
	...
	public org.compiere.model.I_AD_User getCheckedBy() throws RuntimeException
    {
		return (org.compiere.model.I_AD_User)MTable.get(getCtx(), org.compiere.model.I_AD_User.Table_Name)
			.getPO(getCheckedBy_ID(), get_TrxName());	}

	/** Set Checked By.
		@param CheckedBy_ID Checked By	  */
	public void setCheckedBy_ID (int CheckedBy_ID)
	{
		if (CheckedBy_ID < 1) 
			set_Value (COLUMNNAME_CheckedBy_ID, null);
		else 
			set_Value (COLUMNNAME_CheckedBy_ID, Integer.valueOf(CheckedBy_ID));
	}

	/** Get Checked By.
		@return Checked By	  */
	public int getCheckedBy_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_CheckedBy_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set Delivery Challan Date.
		@param DeliveryChallanDate Delivery Challan Date	  */
	public void setDeliveryChallanDate (Timestamp DeliveryChallanDate)
	{
		set_Value (COLUMNNAME_DeliveryChallanDate, DeliveryChallanDate);
	}

	/** Get Delivery Challan Date.
		@return Delivery Challan Date	  */
	public Timestamp getDeliveryChallanDate () 
	{
		return (Timestamp)get_Value(COLUMNNAME_DeliveryChallanDate);
	}

	/** Set Delivery Challan No..
		@param DeliveryChallanNum Delivery Challan No.	  */
	public void setDeliveryChallanNum (String DeliveryChallanNum)
	{
		set_Value (COLUMNNAME_DeliveryChallanNum, DeliveryChallanNum);
	}

	/** Get Delivery Challan No..
		@return Delivery Challan No.	  */
	public String getDeliveryChallanNum () 
	{
		return (String)get_Value(COLUMNNAME_DeliveryChallanNum);
	}
	...
	/** Set Gate Pass Date.
		@param GatePassDate Gate Pass Date	  */
	public void setGatePassDate (Timestamp GatePassDate)
	{
		set_Value (COLUMNNAME_GatePassDate, GatePassDate);
	}

	/** Get Gate Pass Date.
		@return Gate Pass Date	  */
	public Timestamp getGatePassDate () 
	{
		return (Timestamp)get_Value(COLUMNNAME_GatePassDate);
	}

	/** Set Gate Pass No.
		@param GatePassNum Gate Pass No	  */
	public void setGatePassNum (String GatePassNum)
	{
		set_Value (COLUMNNAME_GatePassNum, GatePassNum);
	}

	/** Get Gate Pass No.
		@return Gate Pass No	  */
	public String getGatePassNum () 
	{
		return (String)get_Value(COLUMNNAME_GatePassNum);
	}
	...
	{
		set_Value (COLUMNNAME_GRNDate, GRNDate);
	}
	...
	{
		return (Timestamp)get_Value(COLUMNNAME_GRNDate);
	}

	/** Set GRN Prepared By.
		@param GRNPreparedBy GRN Prepared By	  */
	public void setGRNPreparedBy (String GRNPreparedBy)
	{
		set_Value (COLUMNNAME_GRNPreparedBy, GRNPreparedBy);
	}

	/** Get GRN Prepared By.
		@return GRN Prepared By	  */
	public String getGRNPreparedBy () 
	{
		return (String)get_Value(COLUMNNAME_GRNPreparedBy);
	}
	...
	/** Set CER Attached.
		@param IsCERAttached CER Attached	  */
	public void setIsCERAttached (boolean IsCERAttached)
	{
		set_Value (COLUMNNAME_IsCERAttached, Boolean.valueOf(IsCERAttached));
	}

	/** Get CER Attached.
		@return CER Attached	  */
	public boolean isCERAttached () 
	{
		Object oo = get_Value(COLUMNNAME_IsCERAttached);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set Challan Attached.
		@param IsChallanAttached Challan Attached	  */
	public void setIsChallanAttached (boolean IsChallanAttached)
	{
		set_Value (COLUMNNAME_IsChallanAttached, Boolean.valueOf(IsChallanAttached));
	}

	/** Get Challan Attached.
		@return Challan Attached	  */
	public boolean isChallanAttached () 
	{
		Object oo = get_Value(COLUMNNAME_IsChallanAttached);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set Gate Pass Attached.
		@param IsGPAttached Gate Pass Attached	  */
	public void setIsGPAttached (boolean IsGPAttached)
	{
		set_Value (COLUMNNAME_IsGPAttached, Boolean.valueOf(IsGPAttached));
	}

	/** Get Gate Pass Attached.
		@return Gate Pass Attached	  */
	public boolean isGPAttached () 
	{
		Object oo = get_Value(COLUMNNAME_IsGPAttached);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set PO Attached.
		@param IsPOAttached PO Attached	  */
	public void setIsPOAttached (boolean IsPOAttached)
	{
		set_Value (COLUMNNAME_IsPOAttached, Boolean.valueOf(IsPOAttached));
	}

	/** Get PO Attached.
		@return PO Attached	  */
	public boolean isPOAttached () 
	{
		Object oo = get_Value(COLUMNNAME_IsPOAttached);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set Quotation Attached.
		@param IsQuotationAttached Quotation Attached	  */
	public void setIsQuotationAttached (boolean IsQuotationAttached)
	{
		set_Value (COLUMNNAME_IsQuotationAttached, Boolean.valueOf(IsQuotationAttached));
	}

	/** Get Quotation Attached.
		@return Quotation Attached	  */
	public boolean isQuotationAttached () 
	{
		Object oo = get_Value(COLUMNNAME_IsQuotationAttached);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set Pull Data from SAP (Input GR_NO).
		@param PullDataFromSAP Pull Data from SAP (Input GR_NO)	  */
	public void setPullDataFromSAP (String PullDataFromSAP)
	{
		set_Value (COLUMNNAME_PullDataFromSAP, PullDataFromSAP);
	}

	/** Get Pull Data from SAP (Input GR_NO).
		@return Pull Data from SAP (Input GR_NO)	  */
	public String getPullDataFromSAP () 
	{
		return (String)get_Value(COLUMNNAME_PullDataFromSAP);
	}

	/** Set Quotation Date.
		@param QuotationDate Quotation Date	  */
	public void setQuotationDate (Timestamp QuotationDate)
	{
		set_Value (COLUMNNAME_QuotationDate, QuotationDate);
	}
	...
	{
		return (Timestamp)get_Value(COLUMNNAME_QuotationDate);
	}

	/** Set Quotation No.
		@param QuotationNo Quotation No	  */
	public void setQuotationNo (String QuotationNo)
	{
		set_Value (COLUMNNAME_QuotationNo, QuotationNo);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_QuotationNo);
	}
	...
	/** Set SAP GR_NO.
		@param SAPGR_NO SAP GR_NO	  */
	public void setSAPGR_NO (String SAPGR_NO)
	{
		set_Value (COLUMNNAME_SAPGR_NO, SAPGR_NO);
	}

	/** Get SAP GR_NO.
		@return SAP GR_NO	  */
	public String getSAPGR_NO () 
	{
		return (String)get_Value(COLUMNNAME_SAPGR_NO);
	}
