...
public final class Adempiere
{
	...
	/** Product Name            */
	static public final String	NAME 			= "Alkem Asset Management\u00AE";
	/** URL of Product          */
	static public final String	URL				= "www.alkemlabs.com";
	/** 16*16 Product Image. **/
...
//	static private final String	s_file100x30HR	= "images/AD10030HR.png";
	...
	/** Subtitle                */
	static public final String	SUB_TITLE		= "Alkem Asset Management System";
	static public final String	ADEMPIERE_R		= "AlkemAssetManagement\u00AE";
	static public final String	COPYRIGHT		= "\u00A9 2013-2015 AlkemAssetManagement\u00AE";
	...
	static private final String ONLINE_HELP_URL = "http://www.alkemlabs.com/contact-us";
	...
	private static void setPackageInfo()
	{
		...
		if (s_ImplementationVendor == null)
		{
			s_ImplementationVendor = "Supported by Alkem Laboratories Limited";
			s_ImplementationVersion = "AlkemDMS";
		}
	}	//	setPackageInfo
