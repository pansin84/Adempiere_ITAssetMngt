 ...
 */
public class MyCustomDestinationDataProvider
{
    ...
    //business logic
    public String executeCalls(String destName)
    {
    	String result = null;
        JCoDestination dest;
        try
    ...
    static Properties getDestinationPropertiesFromUI(String client,
            String User,
            String Pw,
            String Langu,
            String Host,
            String System)
    {
        ...
        connectProperties.setProperty(DestinationDataProvider.JCO_PASSWD, Pw);
        connectProperties.setProperty(DestinationDataProvider.JCO_LANG,   Langu);
...
//        test.executeCalls(destName);
//    }
    public String connect(String client,
            String User,
            String Pw,
            String Langu,
            String Host,
...
//         MyCustomDestinationDataProvider test = new MyCustomDestinationDataProvider();
         
         //set properties for the destination and ...
         myProvider.changeProperties(destName, getDestinationPropertiesFromUI(client,    //SAP client
                 User,      //User ID
                 Pw,        //Password
                 Langu,     //Language
                 Host,      //Host
